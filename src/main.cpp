...
int main()
{
    ...
    while(true){
        ...
        {  
            ...
            if(isPosUpdated(robot_pos,robot_pos_old,threshold) || first_data_set){
            ...
            std::cout << "logic Execution time 1 : " << duration1 << " ms" << std::endl;
            std::cout << "logic Execution time 2 : " << duration2 << " ms" << std::endl;
            
            


            std::this_thread::sleep_for(std::chrono::microseconds(10));
            std::cout<<"num data : "<<data_set_index<<std::endl;
       }
